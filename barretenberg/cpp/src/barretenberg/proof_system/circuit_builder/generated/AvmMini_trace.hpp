...
class AvmMiniTraceBuilder {
  public:
    ...
    // TODO: tempalte
    using Polynomial = honk::flavor::AvmMiniFlavor::Polynomial;
    using AllPolynomials = honk::flavor::AvmMiniFlavor::AllPolynomials;

    static constexpr size_t num_fixed_columns = 15;
    ...
    AllPolynomials compute_polynomials()
    {
        ...
        for (size_t i = 0; i < rows.size(); i++) {
            ...
            polys.avmMini_inter_idx[i] = rows[i].avmMini_inter_idx;
            polys.avmMini_mem_idx[i] = rows[i].avmMini_mem_idx;
