...
/**
 * Create AvmMiniProver_ from proving key, witness and manifest.
 *
...
AvmMiniProver_<Flavor>::AvmMiniProver_(std::shared_ptr<typename Flavor::ProvingKey> input_key,
    ...
    , commitment_key(commitment_key)
{
    ...
    prover_polynomials.avmMini_inter_idx = key->avmMini_inter_idx;
    prover_polynomials.avmMini_mem_idx = key->avmMini_mem_idx;
 ...
 *
 */
template <typename Flavor> void AvmMiniProver_<Flavor>::compute_wire_commitments()
{
 ...
 *
 */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_preamble_round()
{
 ...
 *
 */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_wire_commitments_round()
{
    auto wire_polys = key->get_wires();
    auto labels = commitment_labels.get_wires();
    for (size_t idx = 0; idx < wire_polys.size(); ++idx) {
 ...
 *
 */
// template <typename Flavor> void AvmMiniProver_<Flavor>::execute_log_derivative_commitments_round()
// {
 ...
 *
 */
// template <typename Flavor> void AvmMiniProver_<Flavor>::execute_grand_product_computation_round()
// {
 ...
 *
 */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_relation_check_rounds()
{
 ...
 *
 * */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_univariatization_round()
{
 ...
 * */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_pcs_evaluation_round()
{
 ...
 * */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_shplonk_batched_quotient_round()
{
 ...
 * */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_shplonk_partial_evaluation_round()
{
 ...
 * */
template <typename Flavor> void AvmMiniProver_<Flavor>::execute_final_pcs_round()
{
    PCS::compute_opening_proof(commitment_key, shplonk_output.opening_pair, shplonk_output.witness, transcript);
}

template <typename Flavor> plonk::proof& AvmMiniProver_<Flavor>::export_proof()
{
    proof.proof_data = transcript.proof_data;
    return proof;
}

template <typename Flavor> plonk::proof& AvmMiniProver_<Flavor>::construct_proof()
{
...
template class AvmMiniProver_<honk::flavor::AvmMiniFlavor>;
