...
template <typename Flavor> class AvmMiniProver_ {
  ...
  public:
    explicit AvmMiniProver_(std::shared_ptr<ProvingKey> input_key, std::shared_ptr<PCSCommitmentKey> commitment_key);
...
extern template class AvmMiniProver_<honk::flavor::AvmMiniFlavor>;

using AvmMiniProver = AvmMiniProver_<honk::flavor::AvmMiniFlavor>;
